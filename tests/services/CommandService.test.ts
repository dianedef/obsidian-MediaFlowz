...
import { ErrorService } from '../../src/core/services/ErrorService';
...
describe('CommandService', () => {
    ...
    beforeEach(() => {
        ...
        (ErrorService.getInstance as jest.Mock).mockReturnValue(mockErrorService);
    ...
    describe('Feature Toggle Command', () => {
        ...
        it('should emit toggle event', () => {
            ...
            const toggleCommand = mockPlugin.addCommand.mock.calls.find(
